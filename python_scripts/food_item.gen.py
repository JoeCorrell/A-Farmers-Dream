...
output_directory = r'C:\Users\Joe\AppData\Local\com.bridge.dev\bridge\projects\HarvestCraft\BP\items\farming\foods'
...
recipe_output_directory = r'C:\Users\Joe\AppData\Local\com.bridge.dev\bridge\projects\HarvestCraft\BP\recipes\farming\foods'
...
for index, line in enumerate(lines):
    if line.strip() == '"texture_data": {':
        ...
        lines.insert(
            index + 2, f'      "textures": "textures/items/farming/ingredients/{file_name}"\n')
...
if not data_exists:
    ...
    lines.append(
        f'      "textures": "textures/items/farming/ingredients/{file_name}"\n')
    lines.append('    },\n')
    lines.append('  },\n')
