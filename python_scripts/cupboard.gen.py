...
base_output_directory = r"C:\Users\Joe\AppData\Local\com.bridge.dev\bridge\projects\HarvestCraft\BP\blocks\kitchen\furniture\cupboard"
...
for color in colors:
    ...
    block_template = {
        ...
        "minecraft:block": {
            "description": {
                "identifier": f"block:kitchen_cupboard_{color}",
                "menu_category": {
